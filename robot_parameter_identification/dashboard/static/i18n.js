...
const DICT = {
  ...
  'controllers.title': { en: 'Controllers', zh: '控制器' },
  'controllers.active': { en: 'Active controllers', zh: '活动控制器' },
  'controllers.name': { en: 'Name', zh: '名称' },
  'controllers.type': { en: 'Type', zh: '类型' },
  'controllers.state': { en: 'State', zh: '状态' },
  'controllers.no_active': { en: 'No active controllers', zh: '无活动控制器' },
  'controllers.empty': { en: 'No controllers', zh: '无控制器' },
  'controllers.waiting': { en: 'Waiting for controllers', zh: '等待控制器数据' },
  'controllers.unavailable': { en: 'Controllers unavailable', zh: '控制器数据不可用' },
  'controllers.timeout': { en: 'Controllers unavailable: query timed out', zh: '控制器数据不可用：查询超时' },
  'controllers.query_failed': { en: 'Controllers unavailable: query failed', zh: '控制器数据不可用：查询失败' },
  'controllers.stale': { en: 'Controllers unavailable: stale data', zh: '控制器数据不可用：数据已过期' },
